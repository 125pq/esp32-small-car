...
String WebControl::generateHTML() {
    ...
    html += "<div class='param'><label>巡线启动加速持续时长(ms): <span id='v_sbd'>0</span></label><input type='range' id='p_sbd' class='slider' min='0' max='5000' step='10' oninput=\"updateParam('sbd','p_sbd','v_sbd')\"></div>";
    html += "<div class='param'><label>巡线启动加速速度倍率: <span id='v_sbr'>0</span></label><input type='range' id='p_sbr' class='slider' min='1.00' max='2.00' step='0.01' oninput=\"updateParam('sbr','p_sbr','v_sbr')\"></div>";
